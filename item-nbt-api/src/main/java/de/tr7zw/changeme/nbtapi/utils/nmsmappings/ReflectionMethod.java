...
public enum ReflectionMethod {
    ...
    COMPOUND_SET_LONGARRAY(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[]{String.class, long[].class}, MinecraftVersion.MC1_7_R4, new Since(MinecraftVersion.MC1_7_R4, "setLongArray"), new Since(MinecraftVersion.MC1_18_R1, "putLongArray(java.lang.String,long[])")),
    ...
    COMPOUND_GET_LONGARRAY(ClassWrapper.NMS_NBTTAGCOMPOUND, new Class[]{String.class}, MinecraftVersion.MC1_7_R4, new Since(MinecraftVersion.MC1_7_R4, "getLongArray"), new Since(MinecraftVersion.MC1_18_R1, "getLongArray(java.lang.String)")),
